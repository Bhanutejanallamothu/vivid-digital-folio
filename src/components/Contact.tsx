            ...
            <div className="bg-white rounded-xl shadow-md p-8 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@example.com" className="text-gray-600 hover:text-portfolio-blue transition-colors">
                      hello@example.com
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="w-10 h-10 rounded-full bg-gray-100 hover:bg-portfolio-blue transition-colors flex items-center justify-center text-gray-600 hover:text-white">
                    {/* Twitter icon */}
